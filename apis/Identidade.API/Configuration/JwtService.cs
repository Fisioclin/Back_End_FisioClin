...
namespace Identidade.API.Configuration
{
    public class JwtService
    {
        ...
        public JwtAuthResult GenerateTokens(string username, List<string> roles ,string empresaId, string id, ICollection<Claim> claims, DateTime now)
        {
        ...
        /// <param name="now"></param>
        /// <returns>JwtAuthResult</returns>
        public JwtAuthResult Refresh(string refreshToken, List<string> roles,string userName, string accessToken, DateTime now)
        {
            ...
            return GenerateTokens(userName, roles, companyId, Id, principal.Claims.ToArray(), now); // need to recover the original claims
        }
